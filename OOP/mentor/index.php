                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="btn-aksi td-no text-center">
                                        <a class="btn btn-sm btn-outline-warning" style="color:black" onclick="showEditPopup(<?php echo $row['id_mentor']; ?>)">Edit</a>
                                        <a class="btn btn-sm btn-outline-danger" onclick="showDelPopup(<?php echo $row['id_mentor']; ?>)">Del</a>
                                    </td>
